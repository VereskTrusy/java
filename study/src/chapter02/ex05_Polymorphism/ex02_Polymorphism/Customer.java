...
public class Customer {
     ...
     * 생성자 내의 로직 함수로 적용
     */
    private void initCustomer( String customerGrade, double bonusRatio ){
        this.customerGrade = customerGrade; // 기본 고객 등급
        this.bonusRatio = bonusRatio; // 기본 보너스 적립 비율
    }
